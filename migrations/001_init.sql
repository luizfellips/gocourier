...
-- idempotency_keys: effectively-once dedup at ingest
...
-- delivery_attempts: append-only audit of dispatch attempts
...
-- outbox: transactional outbox for NATS publish
...
-- scheduled_notifications: delayed delivery queue
...
-- audit_events: append-only domain event log
